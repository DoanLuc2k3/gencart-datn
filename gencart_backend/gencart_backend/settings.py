...
# Blockchain Settings
MERCHANT_WALLET_ADDRESS = os.environ.get('MERCHANT_WALLET_ADDRESS', '0x742d35Cc6634C0532925a3b844Bc454e4438f44e')
BLOCKCHAIN_PAYMENT_TIMEOUT_HOURS = int(os.environ.get('BLOCKCHAIN_PAYMENT_TIMEOUT_HOURS', 1))
